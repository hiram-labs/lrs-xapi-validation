import { composeRules, restrictToSchema, restrictToCollection, optional, Rule } from '../warnings/common';
...
export default composeRules([
  ...
  (data, path) => {
    ...
    const usedMember = data.member != null && Array.isArray(data.member) && data.member.length > 0;
