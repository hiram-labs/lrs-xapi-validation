import { composeRules, restrictToSchema, optional, required, Rule } from '../warnings/common';
...
export default composeRules([
  ...
  (data, path) => {
    ...
    if (data.usageType === 'http://adlnet.gov/expapi/attachments/signature' && data.contentType !== 'application/octet-stream') {
