import { restrictToSchema, restrictToCollection, optional, Rule } from '../warnings/common';
import { activity, uuid, actor, group, stringValue, language, statementRef, extensions } from '../factory';
