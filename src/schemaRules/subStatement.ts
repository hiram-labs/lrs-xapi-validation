import { restrictToSchema, composeRules, optional, Rule } from '../warnings/common';
...
export default composeRules([
  ...
  (data, path) => {
    ...
    const objectIsSubStatement = data.object && data.object.objectType === 'SubStatement';
