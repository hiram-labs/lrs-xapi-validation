import { restrictToSchema, optional, Rule, composeRules, Warning } from '../warnings/common';
import { scaledValue, numberValue, booleanValue, stringValue, duration, extensions } from '../factory';
