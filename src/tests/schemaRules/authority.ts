...
export default (test: Test) => {
  ...
  itsInvalid(
    ...
    'contains an account on a group',
    test
  );
  itsInvalid(
    {
    ...
    'contains an mbox_sha1sum on a group',
    test
  );
  itsInvalid(
    {
